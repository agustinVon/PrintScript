...
case class OperationSolverImpl() extends OperationSolver{
  ...
  override def solve(operation: Content[String], expr1: Either[ExpressionResultType, Option[Any]], expr2: Either[ExpressionResultType, Option[Any]]): Either[ExpressionResultType, Option[Any]] = {
  ...
  private def solveSumOperation(expr1: Either[ExpressionResultType, Option[Any]], expr2: Either[ExpressionResultType, Option[Any]], line: Int, column: Int) = {
    (expr1, expr2) match {
  ...
  private def solveSubstractionOperation(expr1:Either[ExpressionResultType, Option[Any]], expr2: Either[ExpressionResultType, Option[Any]], line: Int, column: Int) = {
    (expr1, expr2) match {
      case (Left(NUM), Left(NUM)) => Left(NUM)
  ...
  private def solveMultiplicationOperation(expr1:Either[ExpressionResultType, Option[Any]], expr2: Either[ExpressionResultType, Option[Any]], line: Int, column: Int) = {
    (expr1, expr2) match {
      case (Left(NUM), Left(NUM)) => Left(NUM)
  ...
  private def solveDivisionOperation(expr1:Either[ExpressionResultType, Option[Any]], expr2: Either[ExpressionResultType, Option[Any]], line: Int, column: Int) = {
    (expr1, expr2) match {
      case (Left(NUM), Left(NUM)) => Left(NUM)
